...
Public Class Cancel_Bus_Ticket
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Else
            ...
            If dialog = DialogResult.Yes Then
                ...
                Dim deleteQuery As String = "DELETE FROM User_BusTicketBooking WHERE Booking_Id = '" & TextBox1.Text & "'"
    ...
    Private Sub Cancel_Bus_Ticket_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TextBox1.Text = ""
        Label4.Text = ""
        Label7.Text = ""
        Label9.Text = ""
